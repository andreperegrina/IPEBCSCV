<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/MasterPages/Main.Master"  CodeBehind="AdministrarRevision.aspx.cs" Inherits="IPEBCSCV.Process.Revision.AdministrarRevision" %>
                        ...
                        <tr>
                            <td>
                                <table width="100%" style="margin-right: 10px;">
                                    <tr>
                                        <td>
                                            <dx:ASPxButton ID="btnDxNuevo" PostBackUrl="~/Process/Revision/NuevoRevision.aspx"
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="content-card">
        <table style="width: 100%;">
            <tr>
                <td>
                    <h1 class="content-title-card">Administrar revisiones</h1>
                </td>
            </tr>
            <tr>
                <td>
                    <dx:ASPxGridView ID="gvDxCatalogo" OnRowCommand="gvDxCatalogo_RowCommand" AutoGenerateColumns="False" EnableTheming="True" Theme="Moderno"
                        ...
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="RevisionId" Visible="false" VisibleIndex="0">
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetAll" TypeName="IPEBCSCV.BusinessLogic.Manager.RevisionVehiculoManager"></asp:ObjectDataSource>
                </td>
            </tr>
        </table>
    </div>

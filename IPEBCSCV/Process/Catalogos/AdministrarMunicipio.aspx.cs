...
{
    public partial class AdministrarMunicipio : GenericPage
    {
        ...
        protected void gvDxCatalogo_RowCommand(object sender, DevExpress.Web.ASPxGridView.ASPxGridViewRowCommandEventArgs e)
        {
            ...
            if (e.CommandArgs.CommandName.Equals("Remove"))
            {
                ...
                try
                {
                    Municipio removeMunicipio = (Municipio)gvDxCatalogo.GetRow(e.VisibleIndex);
                    ServiceLocator.Instance.GetService<MunicipioManager>().Remove(removeMunicipio);
                    ...
                    if (ex.InnerException != null)
                    {
                        if (ex.InnerException.InnerException != null)
                        {
                            ...
                            if (excepcionIBM.Errors[0].SQLState.Equals("23000") || excepcionIBM.Errors[0].SQLState.Equals("23001"))
                            {
                                ...
                                ScriptManager.RegisterStartupScript(Page, Page.GetType(), "key", "<script type=\"text/javascript\"> refreshMunicipio(); </script>", false);
            ...
            else
            {
                ...
                {
                    Municipio editMunicipio = (Municipio)gvDxCatalogo.GetRow(e.VisibleIndex);
                    Page.Session.Add("EditMunicipioCatalogoID", editMunicipio.MunicipioId);

                    Response.Redirect("/Process/Catalogos/Registro/NuevoMunicipio.aspx");

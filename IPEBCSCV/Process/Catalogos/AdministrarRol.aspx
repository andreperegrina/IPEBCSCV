<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Main.Master" CodeBehind="AdministrarRol.aspx.cs" Inherits="IPEBCSCV.Process.Catalogos.AdministrarRol" %>
                        ...
                        <tr>
                            <td>
                                <table width="100%" style="margin-right: 10px;">
                                    <tr>
                                        <td>
                                            <dx:ASPxButton ID="btnDxNuevo" PostBackUrl="~/Process/Catalogos/Registro/NuevoRol.aspx"
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    <div class="content-card">
        <table style="width: 100%;">
            <tr>
                <td>
                    <h1 class="content-title-card">Administrar roles</h1>
                </td>
            </tr>
            <tr>
                <td>
                    <dx:ASPxGridView ID="gvDxCatalogo" OnRowCommand="gvDxCatalogo_RowCommand" AutoGenerateColumns="False" EnableTheming="True" Theme="Moderno"
                        ...
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="RolId" Visible="false" VisibleIndex="0">
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetAll" TypeName="IPEBCSCV.BusinessLogic.Manager.RolManager"></asp:ObjectDataSource>
                </td>
            </tr>
        </table>
    </div>

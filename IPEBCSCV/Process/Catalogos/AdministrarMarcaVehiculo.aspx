<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/MasterPages/Main.Master" CodeBehind="AdministrarMarcaVehiculo.aspx.cs" Inherits="IPEBCSCV.Process.Catalogos.AdministrarMarcaVehiculo" %>
                        ...
                        <tr>
                            <td>
                                <table width="100%" style="margin-right: 10px;">
                                    <tr>
                                        <td>
                                            <dx:ASPxButton ID="btnDxNuevo" PostBackUrl="~/Process/Catalogos/Registro/NuevoMarcaVehiculo.aspx"
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="content-card">
        <table style="width:100%;">
            <tr>
                <td>
                <h1 class="content-title-card">Administrar marca de vehículos</h1></td>
            </tr>
            <tr>
                <td>
            ...
            <Columns>
                <dx:GridViewDataTextColumn FieldName="MarcaVehiculoId" Visible="false" VisibleIndex="0">
            ...
            <SettingsPager Position="Bottom">
                ...
                <PageSizeItemSettings Caption="Resultados por página" Items="5,10, 20, 50" Visible="true" />
            </SettingsPager>
            <Styles>
                <CommandColumn Spacing="10px" Wrap="False" />
            </Styles>
        </dx:ASPxGridView>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetAll" TypeName="IPEBCSCV.BusinessLogic.Manager.MarcaVehiculoManager"></asp:ObjectDataSource>

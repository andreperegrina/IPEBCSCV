...
{
    public partial class AdministrarRol : GenericPage
    {
        ...
        protected void gvDxCatalogo_RowCommand(object sender, DevExpress.Web.ASPxGridView.ASPxGridViewRowCommandEventArgs e)
        {
            ...
            if (e.CommandArgs.CommandName.Equals("Remove"))
            {
                ...
                try
                {
                    Rol removeRol = (Rol)gvDxCatalogo.GetRow(e.VisibleIndex);
                    ServiceLocator.Instance.GetService<RolManager>().Remove(removeRol);
                    ...
                    if (ex.InnerException != null)
                    {
                        if (ex.InnerException.InnerException != null)
                        {
                            ...
                            if (excepcionIBM.Errors[0].SQLState.Equals("23000") || excepcionIBM.Errors[0].SQLState.Equals("23001"))
                            {
                                ...
                                ScriptManager.RegisterStartupScript(Page, Page.GetType(), "key", "<script type=\"text/javascript\"> refreshRol(); </script>", false);
            ...
            else
            {
                ...
                {
                    Rol editRol = (Rol)gvDxCatalogo.GetRow(e.VisibleIndex);
                    Page.Session.Add("EditRolCatalogoID", editRol.RolId);

                    Response.Redirect("/Process/Catalogos/Registro/NuevoRol.aspx");
                }
            }
        }

<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/MasterPages/Main.Master" CodeBehind="AdministrarUsuario.aspx.cs" Inherits="IPEBCSCV.Process.Catalogos.AdministrarUsuario" %>
                        ...
                        <tr>
                            <td>
                                <table width="100%" style="margin-right: 10px;">
                                    <tr>
                                        <td>
                                            <dx:ASPxButton ID="btnDxNuevo" PostBackUrl="~/Process/Catalogos/Registro/NuevoUsuario.aspx"
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    <div class="content-card">
        <table style="width: 100%;">
            <tr>
                <td>
                    <h1 class="content-title-card">Administrar usuarios</h1>
                </td>
            </tr>
            <tr>
                <td>
        <dx:ASPxGridView ID="gvDxCatalogo" OnRowCommand="gvDxCatalogo_RowCommand" AutoGenerateColumns="False" EnableTheming="True" Theme="Moderno"
            ...
            <Columns>
                <dx:GridViewDataTextColumn FieldName="UsuarioId" Visible="false" VisibleIndex="0">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="NombreCompleto" VisibleIndex="1">
                </dx:GridViewDataTextColumn>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetAll" TypeName="IPEBCSCV.BusinessLogic.Manager.UsuarioManager"></asp:ObjectDataSource>
    </td>
                </tr>
            </table>
                    </div>

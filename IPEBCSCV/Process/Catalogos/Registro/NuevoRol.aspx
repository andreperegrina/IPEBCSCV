<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/MasterPages/Main.Master"  CodeBehind="NuevoRol.aspx.cs" Inherits="IPEBCSCV.Process.Catalogos.Registro.NuevoRol" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    <div class="content-card">
            ...
            <tr>
                <td>
                    <asp:Label ID="lbTitle" CssClass="content-title-card" Text="Crear nuevo rol" runat="server" />
                </td>
            </tr>
            <tr>
                <td>

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Main.Master" CodeBehind="NuevoTipoServicio.aspx.cs" Inherits="IPEBCSCV.Process.Catalogos.Registro.NuevoTipoServicio" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    <div class="content-card">
        <table width="100%">
            <tr>
                <td>
                    <asp:Label ID="lbTitle" CssClass="content-title-card" Text="Crear nuevo" runat="server" />
                    <h1 class="content-title-card"> tipo de servicio</h1>
                </td>
            </tr>
            <tr>
                <td>

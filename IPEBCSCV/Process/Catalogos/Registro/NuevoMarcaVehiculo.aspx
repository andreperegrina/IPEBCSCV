<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Main.Master" CodeBehind="NuevoMarcaVehiculo.aspx.cs" Inherits="IPEBCSCV.Process.Catalogos.Registro.NuevoMarcaVehiculo" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    <div class="content-card">
        <table width="100%">
            <tr>
                <td>
                    <asp:Label ID="lbTitle" CssClass="content-title-card" Text="Crear nueva marca de vehículo" runat="server" />
                </td>
            </tr>
            <tr>
                <td>

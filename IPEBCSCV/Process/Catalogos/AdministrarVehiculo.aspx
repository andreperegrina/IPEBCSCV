<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Main.Master" CodeBehind="AdministrarVehiculo.aspx.cs" Inherits="IPEBCSCV.Process.Catalogos.AdministrarVehiculo" %>
                        ...
                        <tr>
                            <td>
                                <table width="100%" style="margin-right: 10px;">
                                    <tr>
                                        <td>
                                            <dx:ASPxButton ID="btnDxNuevo" PostBackUrl="~/Process/Catalogos/Registro/NuevoVehiculo.aspx"
        ...
        <ContentTemplate>
            <asp:Panel ID="pnl1" runat="server">
                <div class="content-card">
                    <script>
                        function refreshgvCatalogo() {
                            var popup = window['gvDxCatalogoVehiculos'];
                            popup.Refresh();
                        }
                    </script>
                    <table style="width: 100%;">
            <tr>
                <td>
                    <h1 class="content-title-card">Administrar vehículos</h1>
                </td>
            </tr>
            <tr>
                <td>
                    <dx:ASPxGridView ID="gvDxCatalogo" ClientInstanceName="gvDxCatalogoVehiculos"
                        OnRowCommand="gvDxCatalogo_RowCommand" AutoGenerateColumns="False" EnableTheming="True" Theme="Moderno"
                                ...
                                <DataItemTemplate>
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td>
                                                <dx:ASPxButton ID="btnDxShow" OnInit="btnDxShow_Init" CssClass="button-general-only-icon-font orange-button-only-icon  fa"
                                                    CommandName="Show" CssPostfix="none" runat="server" Text="&#xf06e;">
                                                </dx:ASPxButton>
                                            </td>
                                            <td>
                                                <dx:ASPxButton ID="btnDxHide" OnInit="btnDxHide_Init" CssClass="button-general-only-icon-font orange-button-only-icon  fa"
                                                    CommandName="Hide" CssPostfix="none" runat="server" Text="&#xf070;">
                                                </dx:ASPxButton>
                                            </td>
                                            <td>

...
{
    public partial class AdministrarMarcaVehiculo : GenericPage
    {
        ...
        protected void gvDxCatalogo_RowCommand(object sender, DevExpress.Web.ASPxGridView.ASPxGridViewRowCommandEventArgs e)
        {
            ...
            if (e.CommandArgs.CommandName.Equals("Remove"))
            {
                ...
                try
                {
                    MarcaVehiculo removeMarcaVehiculo = (MarcaVehiculo)gvDxCatalogo.GetRow(e.VisibleIndex);
                    ServiceLocator.Instance.GetService<MarcaVehiculoManager>().Remove(removeMarcaVehiculo);
                    ...
                    if (ex.InnerException != null)
                    {
                        if (ex.InnerException.InnerException != null)
                        {
                            ...
                            if (excepcionIBM.Errors[0].SQLState.Equals("23000") || excepcionIBM.Errors[0].SQLState.Equals("23001"))
                            {
                                ...
                                ScriptManager.RegisterStartupScript(Page, Page.GetType(), "key", "<script type=\"text/javascript\"> refreshMarcaVehiculo(); </script>", false);
            ...
            else
            {
                ...
                {
                    MarcaVehiculo editMarcaVehiculo = (MarcaVehiculo)gvDxCatalogo.GetRow(e.VisibleIndex);
                    Page.Session.Add("EditMarcaVehiculoCatalogoID", editMarcaVehiculo.MarcaVehiculoId);
                    Response.Redirect("/Process/Catalogos/Registro/NuevoMarcaVehiculo.aspx");

<%@ Page Language="C#" AutoEventWireup="true"   MasterPageFile="~/MasterPages/Main.Master" CodeBehind="AdministrarIncidencias.aspx.cs" Inherits="IPEBCSCV.Process.Incidencias.AdministrarIncidencias" %>
                        ...
                        <tr>
                            <td>
                                <table width="100%" style="margin-right: 10px;">
                                    <tr>
                                        <td>
                                            <dx:ASPxButton ID="btnDxNuevo" PostBackUrl="~/Process/Catalogos/Registro/NuevoIncidencia.aspx"
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="content-card">
        <table style="width:100%;">
            <tr>
                <td>
                <h1 class="content-title-card">Administrar incidencias</h1></td>
            </tr>
            <tr>
                <td>

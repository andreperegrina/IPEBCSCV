<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Main.Master" CodeBehind="NuevoServicio.aspx.cs" Inherits="IPEBCSCV.Process.Servicio.NuevoServicio" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    <div class="content-card">
        <table width="100%">
            <tr>
                <td>
                    <asp:Label ID="lbTitle" CssClass="content-title-card" Text="Crear nuevo servición" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                    <table class="table-equal-size-columns table-general-form">
                        <tr>
                            ...
                            <td width="5%">
                                <span class="caption-text">Factura</span>
                            </td>
                            <td width="95%">
                                <dx:ASPxTextBox ID="txtDxFactura" CssClass="text-box-general-form" Theme="DevEx" runat="server" Width="100%">
                                    <ValidationSettings SetFocusOnError="True" ValidationGroup="ElementosRequeridos" ErrorDisplayMode="ImageWithTooltip">
                                        <RequiredField IsRequired="True" ErrorText="Elemento requerido" />
                                    </ValidationSettings>
                                </dx:ASPxTextBox>
                            ...
                            <td width="5%">
                                <span class="caption-text">Proveedor</span>
                            </td>
                            <td width="95%">
                                <dx:ASPxTextBox ID="txtDxProveedor" CssClass="text-box-general-form" Theme="DevEx" runat="server" Width="100%">
                                    <ValidationSettings SetFocusOnError="True" ValidationGroup="ElementosRequeridos" ErrorDisplayMode="ImageWithTooltip">
                                        <RequiredField IsRequired="True" ErrorText="Elemento requerido" />
                                    </ValidationSettings>
                                </dx:ASPxTextBox>
                            ...
                            <td width="5%">
                                <span class="caption-text">Importe</span>
                            </td>
                            <td width="95%">
                                <dx:ASPxTextBox ID="txtDxImporte" CssClass="text-box-general-form" Theme="DevEx" runat="server" Width="100%">
                        ...
                        <tr>
                            <td width="5%">
                                <span class="caption-text">Fecha servicio</span>
                            </td>
                            <td width="95%">
                                <dx:ASPxDateEdit ID="dtDxFechaServicio" OnDateChanged="dtDxFechaServicio_DateChanged" CssClass="text-box-general-form" Width="100%" Theme="DevEx" EnableTheming="true" runat="server">
                                    <ValidationSettings SetFocusOnError="True" ValidationGroup="ElementosRequeridos" ErrorDisplayMode="ImageWithTooltip">
                                        <RequiredField IsRequired="True" ErrorText="Elemento requerido" />
                                    </ValidationSettings>
                                </dx:ASPxDateEdit>
                        ...
                        <tr>
                            <td width="5%">
                                <span class="caption-text">Tipo de servicio</span>
                            </td>
                            <td width="95%">
                                <dx:ASPxComboBox ID="cobxDxTipoServicio" runat="server" CssClass="text-box-general-form" Width="100%" Theme="DevEx"
                                    ValueType="System.Int32" ValueField="TipoServicioId" TextField="Nombre" DataSourceID="ObjectDataSource2">
                                        <ValidationSettings SetFocusOnError="True" ValidationGroup="ElementosRequeridos" ErrorDisplayMode="ImageWithTooltip">
                                        <RequiredField IsRequired="True" ErrorText="Elemento requerido" />
                                    </ValidationSettings>
                                </dx:ASPxComboBox>
                                <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="GetAll" TypeName="IPEBCSCV.BusinessLogic.Manager.TipoServicioManager"></asp:ObjectDataSource>
